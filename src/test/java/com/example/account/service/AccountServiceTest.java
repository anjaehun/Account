...
class AccountServiceTest {
    ...
    void successGetAccountsByUserId(){
        ...
        assertEquals("11111111111"
                , accountDtos.get(0).getAccountNumber());
        assertEquals(1000,
                accountDtos.get(0).getBalance());

        assertEquals("22222222222"
                , accountDtos.get(1).getAccountNumber());
        assertEquals(2000,
                accountDtos.get(1).getBalance());

        assertEquals("33333333333"
                , accountDtos.get(2).getAccountNumber());
        assertEquals(3000,
                accountDtos.get(2).getBalance());
    }
